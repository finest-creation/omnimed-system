import 'package:omnimed/views/SplashScreen.dart';
import 'package:flutter/material.dart';
import 'package:omnimed/views/mod01/logado.dart';
import 'package:omnimed/views/mod01/login.dart';
import 'package:omnimed/views/mod01/naoLogado.dart';
import 'package:omnimed/views/mod01/paciente.dart';
import 'package:omnimed/views/mod01/sobre.dart';
import 'package:omnimed/views/mod02/cadastrar_prescricao.dart';
import 'package:omnimed/views/mod02/listar_prescricoes.dart';
import 'package:omnimed/views/mod02/realizar_consulta.dart';
import 'package:omnimed/views/mod02/listar_agendamentos_dia.dart';
import 'package:omnimed/views/mod03/gestao_pagamentos.dart';
import 'package:omnimed/views/mod03/guia_medico.dart';
import 'package:omnimed/views/mod03/solicitar_exames.dart';
import 'package:omnimed/views/mod03/visualizar_exames.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case "/listar-agendamentos-dia":
        return MaterialPageRoute(builder: (_) => const ListarAgendamentosDia());
