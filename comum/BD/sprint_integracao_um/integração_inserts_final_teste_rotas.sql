#USUÁRIO COMUM
INSERT INTO `USUARIO_COMUM` (`USC_SEXO`, `USC_CIDADE`, `USC_BAIRRO`, `USC_DATA_NASCIMENTO`, `USC_ESTADO`, `USC_SENHA`, `USC_ORGAO_EMISSOR`, `USC_CPF`, `USC_NOME`, `USC_RG`, `USC_LOGRADOURO`, `USC_NUMERO`) VALUES
(1, 'Cabedelo', 'Intermares', '1972-02-04', 13, '$2y$10$nOyb/OJkaY.0UUtI24RbNuc/PvLWz.5ySD5btJshiU4oKKAY7KQtO', 'SSPPB', '88445292030', 'Maria da Silva', '378256002', 'Rua Glaube Leite do Egito Reekers', '95'),
(2, 'Guarulhos', 'Jardim Presidente Dutra', '1969-02-04', 23, '$2y$10$k23KcTvpsX38/bf71WedbO7vOPQAIpx/j/SE1G8Mr0pomK5eFYKiO', 'SSPSP', '63899455827', 'Carlos Almeida dos Santos', '271684197', 'Rua Interina', '452'),
(2, 'Chile', 'Das Graças', '2001-10-10', 23, 'jose_bap', 'SSPSP', '09273249035', 'Jose Batista Andrade Pinheiro', '548797451', 'Rua das Conceições', '787'),
(2, 'Chile', 'Das Graças', '2000-10-10', 22, 'jmma', 'SSPSP', '96710382044', 'Jose Maria Marcos Antonio', '548987451', 'Rua das Conceições', '787'),
(1, 'Chile', 'Das Graças', '1999-10-10', 21, 'mjma', 'SSPSP', '67313704011', 'Maria Jose Marcos Antonio', '54879797', 'Rua das Conceições', '787'),
(2, 'Chile', 'Das Graças', '1998-10-10', 20, 'edmundo_matias_evaristo', 'SSPSP', '53676263006', 'Edmundo Matias Evaristo', '488797451', 'Rua das Conceições', '787'),
(1, 'São João da Boa Vista', 'Centro', '1995-06-23', 15, '123456', 'SSP', '20397159838', 'André da Silva', '471753695', 'Ademar de Barros', '55'),
(1, 'Diadema', 'Casa Grande', '2000-03-15', 15, '123456', 'SSP', '64217502818', 'Marcos Junior', '405082186', 'Rua Jadeildo Pereira da Silva', '120'),
(1, 'São João da Boa Vista', 'Centro', '1998-02-19', 1, '123456', 'SSP', '95094673831', 'Carlos Pereira', '489984411', 'Ademar de Barros', '130'),
(2, 'Arapiraca', 'Nova Esperança', '1981-03-24', 3, 'iLEsYpIwJW', 'SSP', '434.277.200-04', 'João Gustavo Martins', '18.171.205-2', 'Rodovia AL-115', '394'),
(1, 'Gurupi', 'Setor União III', '1978-03-05', 4, '6k6744T5oh', 'SSP', '307.242.171-42', 'Josefa Vitória Lavínia Nunes', '43.026.316-8', 'Rua 19', '505'),
(1, 'Colombo', 'Butiatumirim', '1993-04-19', 6, 'o6NsPpeONo', 'SSP', '258.652.436-59', 'Liz Mariana Moreira', '48.425.399-2', 'Rua Vereador Pio José Broto', '445'),
(2, 'Fortaleza', 'Novo Mondubim', '1948-03-25', 8, 'bTEwpS7lJu', 'SSP', '198.887.742-39', 'Francisca Maria Caldeira', '44.332.350-1', 'Rua 101', '932'),
(2, 'Aracruz', 'Barra do Sahy', '1978-03-04', 11, 'OhBerhyAM4', 'SSP', '326.039.884-84', 'Renan Heitor Enzo Silveira', '41.260.160-6', 'Rua Fundão', '548'),
(1, 'Ananindeua', 'Marituba', '1966-06-11', 17, 'sIoMpHhH4R', 'SSP', '347.785.705-45', 'Teresa Isabella Fernanda Barbosa', '10.480.537-7', 'Passagem São José', '633'),
(2, 'São Paulo', 'Santa Efigênia', '2001-12-17', 25, 'Enfermeira@2020', 'SSP', '28369586856', 'Melissa Akatuka de Oliveira', '677632114', 'Rua dos Gusmões', '353'),
(2, 'Curitiba', 'Sítio Cercado', '1994-07-02', 16, 'Enfermeira!1994', 'SSP', '15201152366', 'Miriam Oliveira', '28272287935', 'Rua Jussara', '200'),
(1, 'Boa VistaBoa Vista', 'Cauamé', '1996-07-03', 25, '1cB8O7iGXP', 'SSP', '23879876575', 'Gustavo Rodrigues Matos', '908908765', 'Rua França', '788'),
(1, 'São Paulo', 'Centro', '2000-07-16', 25, 'Oqw9PT!UBiw.Nes2', 'SSP', '99999999999', 'Carlos Eduardo Sampaio', '999999999', 'R. Dr. Teófilo Ribeiro de Andrade', '67'),
(2, 'Arapiraca', 'Nova Esperança', '1981-03-24', 3, 'iLEsYpIwJW', 'SSP', '43427720004', 'João Gustavo Martins', '18.171.205-2', 'Rodovia AL-115', '394'),
(1, 'Gurupi', 'Setor União III', '1978-03-05', 4, '6k6744T5oh', NULL, '30724217142', 'Josefa Vitória Lavínia Nunes', '43.026.316-8', 'Rua 19', '505'),
(1, 'Colombo', 'Butiatumirim', '1993-04-19', 6, 'o6NsPpeONo', 'SSP', '25865243659', 'Liz Mariana Moreira', '48.425.399-2', 'Vereador Pio José Broto', '445'),
(2, 'Fortaleza', 'Novo Mondubim', '1948-03-25', 8, 'bTEwpS7lJu', 'SSP', '19888774239', 'Francisca Maria Caldeira', '44.332.350-1', 'Rua 101', '932'),
(2, 'Aracruz', 'Barra do Sahy', '1978-03-04', 11, 'OhBerhyAM4', NULL, '32203988484', 'Renan Heitor Enzo Silveira', '41.260.160-6', 'Rua Fundão', '548'),
(1, 'Ananindeua', 'Marituba', '1966-06-11', 17, 'sIoMpHhH4R', 'SSP', '34778570545', 'Teresa Isabella Fernanda Barbosa', '10.480.537-7', 'Passagem São José', '633');
...
('ASSOCIAÇÃO MAIS SAUDE SANTA CASA','Premium',250.99),
...
('Paracetamol Genérico',1,'Febre, dores no corpo e dores de cabeça','Não recomendável em casos de suspeita de dengue',2,1);
...
(`PAC_EMAIL`,`PAC_STATUS`,`FK_USUARIO_COMUM_USC_ID`,`FK_PLANOS_PLN_ID`)
VALUES
('maria_silva@hotmail.com',1,1,1),
('jose_bap@hotmail.com', 3, 2, 1),		     	
('jmma@hotmail.com', 4, 3, 1),       				
('mjma@hotmail.com', 5, 4, 1),       				
('edmundo_matias_evaristo@hotmail.com', 6, 5, 1),
('marcos@email.com', 1, 6, 5),
('fernandafernandaaparicio@dkcarmo.com', 1, 7, 1),
('breno-teixeira81@cursomarcato.com.br', 2, 8, 3),
('renata_moura@gruppoitalia.com.br', 1, 9, 4),      
('isaac-damota84@petrobras.com.br', 4, 10, 1);
...
INSERT INTO `FUNCIONARIOS` (`FUN_PRONTUARIO`, `FUN_CATEGORIA`, `FK_USUARIO_COMUM_USC_ID`) VALUES
('ME523698', 1, 2),
('ME222123', 1, 1),
('ME222321', 5, 2),
('EN608617', 2, 1),
...
#MÉDICOS
INSERT INTO `MEDICOS` (`FK_FUNCIONARIOS_FUN_ID`,`FK_FUNCIONARIOS_FK_USUARIO_COMUM_USC_ID`) VALUES
(1, 2),
(2, 1),
(3, 2);
...
#AGENDAMENTOS
INSERT INTO `AGENDAMENTOS` (`AGD_STATUS`,`AGD_ENCAMINHAMENTOS`,`AGD_DATA`,`AGD_HORARIO`,`AGD_MEET_LINK`,`FK_PACIENTES_PAC_ID`,`FK_PACIENTES_FK_USUARIO_COMUM_USC_ID`,`FK_MEDICOS_MED_ID`,`FK_MEDICOS_FK_FUNCIONARIOS_FUN_ID`,`FK_MEDICOS_FK_FUNCIONARIOS_FK_USUARIO_COMUM_USC_ID`,`FK_ESPECIALIDADES_MEDICAS_ESM_ID`, `AGD_TRIAGEM_REALIZADA`, `AGD_RETORNO`) VALUES
(2,0,'2022-06-13','09:00:00','meet.google.com/ciz-jmfz-bzv',1,1,1,1,2,1,0,0),
(1,0, '2022-07-15', '09:00:00', NULL, 1,1,1,1,2,2,0,1),
(0,0, '2022-07-18', '09:00:00', NULL, 2,2,1,1,2,3,0,0),
(1,0, '2022-07-19', '09:00:00', NULL, 3,3,1,1,2,4,0,0),
(1,0, '2022-07-20', '09:00:00', NULL, 4,4,1,1,2,5,1,1),
(1,1, '2022-08-11', '09:00:00', NULL, 5,5,1,1,2,6,1,0);

#TRIAGENS
INSERT INTO `TRIAGENS` (`TRG_SINTOMAS`, `TRG_TABELA_DOR`, `TRG_PRESSAO_SISTOLICA`, `TRG_TEMPERATURA`, `TRG_PRESSAO_DIASTOLICA`, `FK_AGENDAMENTOS_AGD_ID`) 
VALUES ('Dor de Cabeca, Coriza, Febre', '9', '36', '38.8', '34', '2');

#CONSULTAS ONLINE
INSERT INTO `CONSULTAS_ONLINE` (`CNS_DATA`,`CNS_ANOTACOES`,`CNS_SINTOMAS_IDENTIFICADOS`,`CNS_DIAGNOSTICO`,`FK_AGENDAMENTOS_AGD_ID`) VALUES
('2022-06-13','Baixa prioridade','Dor de cabeça, febre e coriza', 'Enxaqueca Nervosa', 1),
('2022-07-15', 'Alta prioridade', 'Diarreira', 'Virose',2),
('2022-08-12', 'Paciente com muita dor nas costas', 'Dores Constantes na Coluna', 'Paciente possui hérnia de disco',3),
('2022-08-11', 'Nenhum sintoma identificado', 'N/a', 'Nenhum diagnostico identificado',4);
...
('1 semana','Não tomar sob suspeitas de dengue','ASSINATURA','2022-06-13',1,1,1,2),
('30 dias', 'Tomar pós almoço', 'ASSINATURA', '2022-06-20', 1, 3, 3, 2),
('15 dias', 'Toma pela manhã e a noite', 'ASSINATURA', '2022-06-20', 1, 3, 3, 2);

#REMÉDIOS PRESCRIÇÕES
INSERT INTO `REMEDIOS_PRESCRICOES`
(`FK_PRESCRICOES_PRC_ID`,`FK_REMEDIOS_RMD_ID`,`RMP_ESQUEMA_POSOLOGICO`) VALUES
...
('Exame de sangue', 'imagem1.png', 'Em jejum', '2022-06-23 15:42:20', 2, 'resultado1.png', NULL, 2, 2, 1, 1, 1),
('Ultrassom', 'imagem2.png', NULL, '2022-06-21 15:43:22', 2, 'resultado2.png', NULL, 3, 3, 2, 1, 1);
...
('2022-06-30', '2022-06-23', 3000.00, 6, 6),
('2022-05-13', '2022-05-10', 580.00, 1, 1),
('2022-06-30', '2022-06-29', 750.00, 8, 8),
('2022-03-31', '2022-04-01', 1000.00, 7, 7);
...
('2022-06-01', '2022-06-01', 5500.00, 1500.00, 7000.00, 1, 1, 2),
('2022-05-01', '2022-05-01', 3000.00, 500.00, 3500.00, 1, 1, 2),
('2022-03-02', '2022-03-01', 5500.00, 1000.00, 6500.00, 2, 2, 1);

#RESPONSAVEIS
INSERT INTO `RESPONSAVEIS` (`RES_QTD_FILHOS`, `RES_QUAIS_TRAT_MED`, `RES_TEM_ALERGIA_MEDICA`, `RES_QUAL_MEDICACAO`, `RES_QUAIS_ALERGIAS`, `RES_TEL_CELULAR1`, `RES_UTILIZA_MEDICACAO`, `RES_TEL_CELULAR2`, `RES_TEM_FILHOS`, `RES_QUAIS_DOENCAS_CRONICAS`, `RES_DOENCAS_CRONICAS`, `RES_TRATAMENTO_MEDICO`, `FK_PACIENTES_PAC_ID`, `FK_PACIENTES_FK_USUARIO_COMUM_USC_ID`) VALUES 
('1', 'Contra Diabetes', '1', 'Biguanidas', 'Amoxilina', '1998765432', '1', '1991234567', '1', 'Diabetes', '1', '1', '1', '1'),
('2', 'Contra Cancer', '2', 'Quimioterapia', 'Leite e Queijo', '3598765432', '2', '3591234567', '1', 'Cancer', '2', '2', '2', '2'),
('3', 'Contra Obesidade', '3', 'Dieta', 'Poeira, Pelo e Cravo', '1198765432', '3', '1191234567', '3', 'Obesidade', '3', '3', '3', '3'),
('4', 'Contra Fibrose Cística', '4', 'Suplemento Alimentar, Antibiótico, Penicilina e Remédio para Tosse', 'Vermelhidão, Descamação, Irritação e Coceira Intensa.', '2198765432', '4', '2191234567', '4', 'Fibrose Cística', '4', '4', '4', '4'),
('5', 'Osteoporose', '5', 'Vitamina, Suplemento Alimentar e Saúde Óssea', 'Leite, Queijo, Manteiga, Requeijão e Creme', '4198765432', '5', '4191234567', '5', 'Contra Osteoporose', '5', '5', '5', '5');
