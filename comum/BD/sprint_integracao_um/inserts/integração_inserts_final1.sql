...
#AGENDAMENTOS
INSERT INTO `agendamentos` (`AGD_STATUS`,`AGD_ENCAMINHAMENTOS`,`AGD_DATA`,`AGD_HORARIO`,`AGD_MEET_LINK`,`FK_PACIENTES_PAC_ID`,`FK_PACIENTES_FK_USUARIO_COMUM_USC_ID`,`FK_MEDICOS_MED_ID`,`FK_MEDICOS_FK_FUNCIONARIOS_FUN_ID`,`FK_MEDICOS_FK_FUNCIONARIOS_FK_USUARIO_COMUM_USC_ID`,`FK_ESPECIALIDADES_MEDICAS_ESM_ID`) VALUES
(2,0,'2022-06-13','09:00:00','meet.google.com/ciz-jmfz-bzv',1,1,1,1,2,1),
(1,0, '2022-07-15', '09:00:00', NULL, 1,1,1,1,2,2),
(0,0, '2022-07-18', '09:00:00', NULL, 2,2,1,1,2,3),
(1,0, '2022-07-19', '09:00:00', NULL, 3,3,1,1,2,4),
(1,0, '2022-07-20', '09:00:00', NULL, 4,4,1,1,2,5),
(1,1, '2022-08-11', '09:00:00', NULL, 5,5,1,1,2,6);
