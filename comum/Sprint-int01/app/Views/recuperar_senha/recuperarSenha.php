            ...
            <div class="container">
                ...
                <form action="/recuperar_senha/enviar_email" method="POST" role="form" class="php-email-form" style="align-items: center;">
                    ...
                    <div class="text-center mt-5" style="margin-right: 5%;">
                        <button type="submit" style="width: 20%;background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Enviar email</button>
                        <a href="/" style="width: 20%;background: #0f928c;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 50px;">Cadastre-se</a>
                    </div>
                </form>
