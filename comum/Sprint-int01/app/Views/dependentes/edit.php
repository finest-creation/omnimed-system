...
$usuarioComumDep = new UsuarioComum();
$pacienteDep = new Pacientes();

$dependenteModel = new DependentesModel();
$usuarioComumDepModel = new UsuarioComumModel();
$pacienteDepModel = new PacientesModel();

$dependente = $dependenteModel->find($id);
$pacienteDep = $pacienteDepModel->find($dependente->FK_PACIENTES_PAC_ID);
$usuarioComumDep = $usuarioComumDepModel->find($pacienteDep->FK_USUARIO_COMUM_USC_ID);
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    <p>Para editar o dependente selecionado, preencha os campos abaixo.</p>
                </div>

                <a href="/dependentes/listagem" class="appointment-btn scrollto">Voltar</a>
                <br />
                <br />

                <form action="/dependentes/atualizar/<?php echo $id ?>" method="POST" role="form" class="php-email-form">
                    <div class="row">
                        <input name="RES_ID" value="<?php echo $FK_RESPONSAVEL_RES_ID ?>" hidden>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                Nome Completo
                                <input type="text" name="USC_NOME" class="form-control" id="nome_dependente" value="<?php echo $usuarioComumDep->USC_NOME; ?>" placeholder="Nome Completo" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                        ...
                        <div class="row">
                            <div class="col-md-8 form-group mt-3 mt-md-0">
                                Logradouro
                                <input type="text" class="form-control" name="USC_LOGRADOURO" id="logradouro_dependente" value="<?php echo $usuarioComumDep->USC_LOGRADOURO; ?>" placeholder="Logradouro" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                                <div class="validate"></div>
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                Número
                                <input type="text" class="form-control" name="USC_NUMERO" id="numero_dependente" value="<?php echo $usuarioComumDep->USC_NUMERO; ?>" placeholder="Número" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                Bairro
                                <input type="text" class="form-control" name="USC_BAIRRO" id="bairro_dependente" value="<?php echo $usuarioComumDep->USC_BAIRRO; ?>" placeholder="Bairro" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                                <div class="validate"></div>
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                                Cidade
                                <input type="text" class="form-control" name="USC_CIDADE" id="cidade_dependente" value="<?php echo $usuarioComumDep->USC_CIDADE; ?>" placeholder="Cidade" data-rule="minlen:4" data-msg="Por favor, digite pelo menos 4 caracteres" required>
                                <div class="validate"></div>
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
