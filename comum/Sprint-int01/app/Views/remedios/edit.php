...
$remedios = $remediosModel->find($id);

$usoRemedios = new UsoRemedios();
$usoRemediosModel = new UsoRemediosModel();
$usoRemedios = $usoRemediosModel->findAllById($id);
...
<body>
    ...
    <main id="main">
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <form action="/remedios/salvarEdicao" method="post" role="form" class="php-email-form">
                    <div class="row">
                        <input name="RMD_ID" value="<?php echo $remedios->RMD_ID ?>" hidden>
                        <div class="col-md-5 form-group">
                            Nome
                            <input type="text" class="form-control" name="RMD_NOME" id="nome" placeholder="Exemplo: Aspirina" data-rule="minlen:4" data-msg="Por favor, digite ao menos 4 caracteres" value="<?php echo $remedios->RMD_NOME ?>">
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-3 form-group">
                            Dosagem
                            <input type="text" class="form-control" name="RMD_DOSAGEM" id="dosagem" placeholder="Exemplo: 100ml" value="<?php echo $remedios->RMD_DOSAGEM ?>">
                            <div class="validate"></div>
                        </div>
                        ...
                        <div class="col-md-7 form-group mt-3 mt-md-0">
                            ...
                            <select id="forma_farmaceutica" class="form-select" name="FK_FORMAS_FARMACEUTICAS_FRM_ID">
                                <?php foreach ($formasFarmaceuticas as $dado) { ?>
                        ...
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                            Indicações
                            <textarea type="text" class="form-control" name="RMD_INDICACAO" id="indicacoes" placeholder="Exemplo: Dores agudas de cabeça" rows="3"><?php echo $remedios->RMD_INDICACAO ?></textarea>
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                            Contraindicações
                            <textarea type="text" class="form-control" name="RMD_CONTRAINDICACAO" id="contraindicacoes" placeholder="Exemplo: Casos de suspeita de dengue" rows="3"><?php echo $remedios->RMD_CONTRAINDICACAO ?></textarea>
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-3 form-group">
                            Disponível?
                            <input type="text" class="form-control" name="RMD_DISPONIVEL" id="disponivel" placeholder="Exemplo: 0 ou 1" value="<?php echo $remedios->RMD_DISPONIVEL ?>">
                            <div class="validate"></div>
                        </div>
                        <div class="col-md-10 form-group mt-3">
                            ...
                            <div class="div-finalidades">
                                ...
                                <?php foreach ($usoRemedios as $dado) { ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group mt-3 mt-md-0">
                                            <select id="finalidade" class="form-select" name="finalidade_existente" disabled>
                                                <?php foreach ($finalidades as $dadoF) {
    ...
    <script type="text/javascript">
        var $finalidade = (
            ...
            <?php foreach ($finalidades as $dado) { ?>
