...
$formaFarmaceutica = new FormasFarmaceuticas();
$formaFarmaceuticaModel = new FormasFarmaceuticasModel();
    ...
    <main id="main">
        ...
        <section id="counts" class="counts">
            <div class="container">
                ...
                <a href="/remedios/novo" class="appointment-btn scrollto">Cadastrar</a>
                <br />
                <br />
                                ...
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($remedios as $remedio) {
                                            $formaFarmaceutica = $formaFarmaceuticaModel->find($remedio->FK_FORMAS_FARMACEUTICAS_FRM_ID);
                                        ?>
                                            <tr>
                                                <td><?php echo $remedio->RMD_NOME; ?></td>
                                                <td><?php echo $formaFarmaceutica->FRM_DESCRICAO; ?></td>
                                                <td><?php echo $remedio->RMD_DOSAGEM; ?></td>
                                                <td><a href="/remedios/excluir/<?php echo $remedio->RMD_ID; ?>" class="deletar"><span class='bi bi-trash'></span></a></td>
                                                <td><a href="/remedios/editar/<?php echo $remedio->RMD_ID; ?>"><span class='bi bi-pencil-square'></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "language": {
                    ...
                    "infoFiltered": "(filtrado do _MAX_ total de remedios)",
                    "search": "Pesquisar:",
