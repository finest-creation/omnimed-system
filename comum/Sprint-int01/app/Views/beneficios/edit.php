...
$beneficio = $beneficiosModel->find($id);
    ...
    <main id="main">
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <a href="/beneficios/listagem" class="appointment-btn scrollto">Voltar</a>
                <br />
                <br />

                <form action="/beneficios/salvar" method="post" role="form" class="php-email-form">
                    <div class="row">
                        <input name="BNF_ID" value="<?php echo $beneficio->BNF_ID ?>" hidden>
                        <div class="mb-3">
                            Descrição
                            <input type="text" name="BNF_DESCRICAO" class="form-control" id="descricao" placeholder="Descrição" value="<?php echo $beneficio->BNF_DESCRICAO ?>" required>
