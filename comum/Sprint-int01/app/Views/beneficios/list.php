    ...
    <main id="main">
        ...
        <section id="counts" class="counts">
            <div class="container">
                ...
                <a href="/beneficios/novo" class="appointment-btn scrollto">Cadastrar</a>
                <br />
                <br />
                        ...
                        <div class="col-md-12">
                            <div class="gv">
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($beneficios as $key => $beneficio) { ?>
                                            <tr>
                                                <td><?php echo $beneficio->BNF_DESCRICAO; ?></td>
                                                <td><a href="/beneficios/excluir/<?php echo $beneficio->BNF_ID; ?>" class="deletar"><span class='bi bi-trash'></span></a></td>
                                                <td><a href="/beneficios/editar/<?php echo $beneficio->BNF_ID; ?>"><span class='bi bi-pencil-square'></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "language": {
                    ...
                    "infoFiltered": "(filtrado do _MAX_ total de beneficios)",
                    "search": "Pesquisar:",
