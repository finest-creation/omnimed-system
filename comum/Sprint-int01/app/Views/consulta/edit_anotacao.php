    ...
    <main id="main">
        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container">
                ...
                <form action="/consulta/salvarnota" method="post" role="form" class="php-email-form">

                    <div class="col">
                        <input name="CNS_ID" value="<?php echo $consulta->CNS_ID ?>" hidden>
                        <div class="row-md-4 form-group mt-2">
                            Nota
                            <input type="text" name="CNS_NOTA" class="form-control" id="nome" placeholder="Nota da consulta" data-rule="minlen:3" data-msg="Por favor, digite pelo menos 3 caracteres" value="<?php echo $consulta->CNS_ANOTACOES ?>">
