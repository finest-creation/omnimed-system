...
$especialidadeMedica = $especialidadeMedicaModel->find($id);
?>
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <!-- <a href="index.html"><img src="/Assets/images/logo_completa_2.png" alt="" class="logo_inicio"></a> -->
    ...
    <main id="main">
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <a href="/especialidades_medicas/listagem" class="appointment-btn scrollto">Voltar</a>
                <br />
                <br />

                <form action="/especialidades_medicas/salvar" method="post" role="form" class="php-email-form">
                    <div class="row">
                        <input name="ESM_ID" value="<?php echo $especialidadeMedica->ESM_ID ?>" hidden>
                        <div class="mb-3">
                            Descrição
                            <input type="text" name="ESM_DESCRICAO" class="form-control" id="descricao" placeholder="Descrição" value="<?php echo $especialidadeMedica->ESM_DESCRICAO ?>" required>
