    ...
    <main id="main">
        ...
        <section id="counts" class="counts">
            <div class="container">
                ...
                <a href="/especialidades_medicas/novo" class="appointment-btn scrollto">Cadastrar</a>
                <br />
                <br />
                        ...
                        <div class="col-md-12">
                            <div class="gv">
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($especialidadesMedicas as $key => $especialidadeMedica) { ?>
                                            <tr>
                                                <td><?php echo $especialidadeMedica->ESM_DESCRICAO ?></td>
                                                <td><a data-url="/especialidades_medicas/excluir/<?php echo $especialidadeMedica->ESM_ID ?>" class="deletar-especial"><span class='bi bi-trash'></span></a></td>
                                                <td><a href="/especialidades_medicas/editar/<?php echo $especialidadeMedica->ESM_ID ?>"><span class='bi bi-pencil-square'></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
