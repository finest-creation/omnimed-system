                ...
                <form action="/especialidades_medicas/salvar" method="post" role="form" class="php-email-form">
                    ...
                    <div class="col">
                        <div class="row-md-4 form-group mt-2">
                            <input type="text" name="ESM_DESCRICAO" class="form-control" id="descricao" placeholder="Especialidade Médica" data-rule="minlen:5" data-msg="Por favor, digite pelo menos 5 caracteres">
