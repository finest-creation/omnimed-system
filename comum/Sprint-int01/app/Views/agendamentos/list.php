        ...
        <section id="counts" class="counts">
            ...
            <div class="row">
                <div class="col-md-3 mt-2">
                    <a href="/" class="appointment-btn scrollto"><span class="d-none d-md-inline">Voltar</a>
                </div>

                <?php if (sizeof($agendamentos) == 0 && isset($_SESSION["usuario"]["email"])) { ?>
                    <div class="col-md-3 mt-2">
                        <a href="/agendamentos/novo" class="appointment-btn scrollto"><span class="d-none d-md-inline">Agendar CONSULTA</a>
                    </div>
                <?php } ?>
            </div>
