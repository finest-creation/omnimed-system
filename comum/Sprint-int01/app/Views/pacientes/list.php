        ...
        <section id="counts" class="counts">
            <div class="container">
                <div class="section-title margem">
                    ...
                    <p>Abaixo, a lista dos pacientes cadastrados.</p>
                </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($pacientes as $key => $paciente) { ?>
                                            <tr style="text-align: center;">
                                                ...
                                                <td><?php $data = date_create($paciente->USC_DATA_NASCIMENTO);
                                                    echo date_format($data, 'd/m/Y'); ?></td>
                                                <td><?php echo $paciente->USC_CPF; ?></td>
                                                <td><?php echo $paciente->PAC_EMAIL; ?></td>
                                                <td><?php echo $paciente->PLN_NOME; ?></td>
                                                <td><?php echo $paciente->PLN_INSTITUICAO; ?></td>
                                                <td><?php echo $paciente->PAC_STATUS; ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "language": {
                    ...
                    "search": "Pesquisar:",
                    "searchPlaceholder": "Nome, E-mail, Plano...",
                    "paginate": {
                        "first": "Primeiro",
                        "last": "Último",
                        "next": "Próximo",
