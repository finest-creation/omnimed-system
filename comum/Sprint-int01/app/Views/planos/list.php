    ...
    <main id="main">
        ...
        <section id="counts" class="counts">
            <div class="container">
                ...
                <a href="/planos/novo" class="appointment-btn scrollto">Cadastrar</a>
                <br />
                <br />
                                ...
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($planos as $key => $plano) { ?>
                                            <tr>
                                                <td><?php echo $plano->PLN_NOME ?></td>
                                                <td><?php echo $plano->PLN_INSTITUICAO ?></td>
                                                <td><?php echo $plano->PLN_PRECO ?></td>
                                                <td><a data-url="/planos/excluir/<?php echo $plano->PLN_ID ?>" class="deletar-especial"><span class='bi bi-trash'></span></a></td>
                                                <td><a href="/planos/editar/<?php echo $plano->PLN_ID ?>"><span class='bi bi-pencil-square'></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
