    ...
    <main id="main">
        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container">
                ...
                <form action="/planos/criar" method="post" role="form" class="php-email-form">

                    <div class="col">
                        <div class="row-md-4 form-group mt-2">
                            Nome
                            <input type="text" name="PLN_NOME" class="form-control" id="nome" placeholder="Nome do Plano" data-rule="minlen:3" data-msg="Por favor, digite pelo menos 3 caracteres">
                            <div class="validate"></div>
                        </div>
                        <div class="row">
                            <div class="row-md-4 form-group mt-2">
                                Instituição
                                <input type="text" name="PLN_INSTITUICAO" class="form-control" id="instituicao" placeholder="Instituição Médica" data-rule="minlen:3" data-msg="Por favor, digite pelo menos 3 caracteres">
                                <div class="validate"></div>
                            </div>
                            <div class="row-md-4 form-group mt-2">
                                Preço
                                <input type="number" name="PLN_PRECO" class="form-control" id="preco" placeholder="Preço" data-rule="minlen:3" data-msg="Por favor, digite pelo menos 3 caracteres" step=".01">
                                <div class="validate"></div>
                            </div>
                            <div class="row-md-4 form-group mt-2">
