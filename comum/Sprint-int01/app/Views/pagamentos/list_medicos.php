...
$medicos = $medicosModel->dadosDeTodosMedicos();
        ...
        <section id="counts" class="counts">
            <div class="container">
                <div class="section-title margem">
                    ...
                    <p>Abaixo, a lista dos médicos cadastrados. Clique no botão na coluna "Histórico de pagamento" para acessar todos os pagamentos do médico, ou no botão abaixo para listar todos os médicos com salários atrasados.</p>
                </div>

                <a href="/pagamentos/medicos/aberto" class="appointment-btn scrollto">Pagamentos atrasados</a>
                <br />
                <br />
                                ...
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($medicos as $key => $medico) { ?>
                                            <tr style="text-align: center;">
                                                <td><?php echo $medico->USC_NOME; ?></td>
                                                <td><?php echo $medico->USC_CPF; ?></td>
                                                <td><?php echo $medico->FUN_PRONTUARIO; ?></td>
                                                <td><a href="/pagamentos/medicos/<?php echo $medico->FK_FUNCIONARIOS_FUN_ID; ?>"><span class="bi bi-receipt-cutoff"></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
