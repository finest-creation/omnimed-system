...
$pagamentos = $pagamentosModel->pacientesInadimplentes();
        ...
        <section id="counts" class="counts">
            <div class="container">
                <div class="section-title margem">
                    <h2>Listagem de Pacientes com pagamentos atrasados</h2>
                    <p>Abaixo, uma lista dos pacientes com a última fatura em aberto.</p>
                </div>

                <a href="/pagamentos/pacientes/" class="appointment-btn scrollto">Voltar</a>
                <br />
                <br />
                                ...
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($pagamentos as $key => $pagamento) { ?>
                                            <tr style="text-align: center;">
                                                <td><?php echo $pagamento->USC_NOME; ?></td>
                                                <td><?php echo $pagamento->USC_CPF; ?></td>
                                                <td><?php echo $pagamento->PLN_NOME; ?></td>
                                                <td><a href="/pagamentos/pacientes/<?php echo $pagamento->USC_ID; ?>"><span class="bi bi-receipt-cutoff"></span></a></td>
                                                <td><a data-url="/pagamentos/pacientes/confirmar/<?php echo $pagamento->USC_ID; ?>/<?php echo $pagamento->PGD_ID; ?>" class="confirmar-pagamento"><span class="bi bi-check2-square"></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
    ...
    <script>
        ...
        $(document).on('click', '.confirmar-pagamento', function() {
            if (confirm("Deseja confirmar este pagamento? Essa ação não pode ser revertida")) {
                ...
                if (confirm("O paciente deseja continuar com o plano?")) {
                    $status = 1;
                }
