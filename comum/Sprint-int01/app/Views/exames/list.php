...
$exames = $examesModel->obterExamesPorIdPaciente($FK_PACIENTE_PAC_ID);
...
<body>
        ...
        <section id="counts" class="counts">
            <div class="container">
                <div class="section-title margem">
                    ...
                    <p>Abaixo, uma listagem dos exames que foram solicitados.</p>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    <thead style="text-align: center;">
                                        <tr>
                                            ...
                                            <th>Considerações</th>
                                            <th>Resultado</th>
                                            <th>Reenviar solicitação</th>
                                        </tr>
                                    </thead>
                                    <tbody style="text-align: center;">
                                        <?php foreach ($exames as $key => $exames) { ?>
                                            <tr>
                                                <td><?php echo $exames->EXM_NOME; ?></td>
                                                <td><?php if ($exames->EXM_AUTORIZADO == 1) {
                                                        echo "Pendente";
                                                    } elseif ($exames->EXM_AUTORIZADO == 0) {
                                                        echo "Não autorizado";
                                                    } else {
                                                        echo "Autorizado";
                                                    } ?></td>
                                                <td><?php echo $exames->EXM_AGENDAMENTO; ?></td>
                                                <td><?php echo $exames->EXM_OBS_SECRETARIO; ?></td>
                                                <td><a href="/exames/baixar/2/<?php echo $exames->EXM_ANEXO_RESULTADO; ?>" id="baixar"><span class="bi bi-download"></span></a></td>
                                                <td><?php if ($exames->EXM_AUTORIZADO == 0) { ?>
                                                        <a href="/exames/novo"><span class="bi bi-eye"></span></a>
                                                    <?php } elseif ($exames->EXM_AUTORIZADO == 1) { ?>
                                                        Pendente
                                                    <?php } else { ?>
                                                        Aprovado
                                                    <?php } ?>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "language": {
                    ...
                    "search": "Pesquisar:",
                    "searchPlaceholder": "ID, Exame, Data...",
                    "paginate": {
                        "first": "Primeiro",
                        "last": "Último",
                        "next": "Próximo",
    ...
    <!-- Import para mensagem da confirmacao de exclusao -->
