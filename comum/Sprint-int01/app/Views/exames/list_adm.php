        ...
        <section id="counts" class="counts">
            <div class="container">
                <div class="section-title margem">
                    ...
                    <p>Abaixo, uma listagem dos exames que foram realizados.</p>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <tbody style="text-align: center;">
                                        <?php foreach ($exames as $key => $exames) { ?>
                                            <tr>
                                                ...
                                                <td><a href="/exames/visualizar/<?php echo $exames->EXM_ID; ?>"><span class="bi bi-eye"></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
