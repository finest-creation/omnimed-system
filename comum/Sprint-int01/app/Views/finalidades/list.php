    ...
    <main id="main">
        ...
        <section id="counts" class="counts">
            <div class="container">
                ...
                <a href="/finalidades/novo" class="appointment-btn scrollto">Cadastrar</a>
                <br />
                <br />
                                ...
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($finalidades as $key => $finalidade) { ?>
                                            <tr>
                                                <td><?php echo $finalidade->FIN_DESCRICAO; ?></td>
                                                <td><a data-url="/finalidades/excluir/<?php echo $finalidade->FIN_ID; ?>" class="deletar-especial"><span class='bi bi-trash'></span></a></td>
                                                <td><a href="/finalidades/editar/<?php echo $finalidade->FIN_ID; ?>"><span class='bi bi-pencil-square'></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "language": {
                    ...
                    "infoFiltered": "(filtrado do _MAX_ total de finalidades)",
                    "search": "Pesquisar:",
