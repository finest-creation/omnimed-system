...
$query = $db->query('SELECT u.USC_NOME, m.MED_ID, e.ESM_DESCRICAO FROM medicos as m, funcionarios as f, usuario_comum as u, especialidades_medicas as e WHERE m.FK_FUNCIONARIOS_FUN_ID = f.FUN_ID AND f.FK_USUARIO_COMUM_USC_ID = u.USC_ID;');
        ...
        <section id="counts" class="counts">
            <div class="container">
                <div class="section-title margem">
                    <h2>Médicos</h2>
                    <p>Abaixo, uma listagem dos médicos.</p>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    <thead style="text-align: center;">
                                        <tr>
                                            ...
                                            <th>Especialidade</th>
                                            <!--<th>Antendimento com Urgência?</th>-->
                                        </tr>
                                    </thead>
                                    <tbody style="text-align: center;">
                                        <?php foreach ($results as $row) { ?>
                                            <tr>
                                                <td><?php echo $row->USC_NOME; ?></td>
                                                <td><?php echo $row->ESM_DESCRICAO; ?></td>
                                                <!--<td>
                                                    <input type="radio" name="urgencia" id="sim" value="1">Sim
                                                    <input type="radio" name="urgencia" id="nao" value="0">Não
                                                </td>-->
                                            </tr>
                                        <?php } ?>
                                    </tbody>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "language": {
                    ...
                    "search": "Pesquisar:",
                    "searchPlaceholder": "Nome, Especialidade",
                    "paginate": {
                        "first": "Primeiro",
                        "last": "Último",
                        "next": "Próximo",
