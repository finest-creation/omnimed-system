        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <br><br><br><br>
                    <h2>Cadastro de Contato Setorial</h2>
                    <p>Para cadastrar o contato setorial, preencha os campos abaixo.</p>
                </div>
                ...
                <form action="/contatos_setoriais/salvar" method="POST" role="form" class="php-email-form">
                    <div class="row">
                        <div class="mb-3">
                            Setor
                            <input type="text" name="CSE_SETOR" class="form-control" id="setor" placeholder="Setor" required>
                            <div class="validate"></div>
                        </div>
                        <div class="mb-3">
                            E-mail
                            <input type="email" name="CSE_EMAIL" class="form-control" id="email" placeholder="E-mail" required>
                            <div class="validate"></div>
                        </div>
                        <div class="mb-3">
                            Telefone fixo
                            <input type="tel" name="CSE_TELEFONE_FIXO" class="form-control" id="telefoneFixo" placeholder="DDDFFFFFFFF" required>
                            <div class="validate"></div>
                        </div>
                        <div class="mb-3">
                            Telefone celular
                            <input type="tel" name="CSE_TELEFONE_CELULAR" class="form-control" id="telefoneCelular" placeholder="DDDCCCCCCCCC" required>
                            <div class="validate"></div>
                        </div>
