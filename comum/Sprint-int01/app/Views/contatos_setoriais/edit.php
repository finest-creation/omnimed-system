...
// Buscar o contato setorial pelo id
$contatosSetoriaisModel = new ContatosSetoriaisModel();
$contatosSetoriais = $contatosSetoriaisModel->find($id);
        ...
        <section id="register" class="register section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <br><br><br><br>
                    <h2>Editar Contato Setorial</h2>
                    <p>Para editar o contato setoral, preencha os campos abaixo.</p>
                </div>

                <a href="/contatos_setoriais/listagem" class="appointment-btn scrollto">Voltar</a>
                <br />
                <br />

                <form action="/contatos_setoriais/salvar" method="POST" role="form" class="php-email-form">
                    <div class="row">
                        <input name="CSE_ID" value="<?php echo $contatosSetoriais->CSE_ID ?>" hidden>
                        <div class="mb-3">
                            E-mail
                            <input type="email" name="CSE_EMAIL" class="form-control" id="email" placeholder="e-mail" value="<?php echo $contatosSetoriais->CSE_EMAIL ?>" required>
                            <div class="validate"></div>
                        </div>
                        <div class="mb-3">
                            Telefone fixo
                            <input type="tel" name="CSE_TELEFONE_FIXO" class="form-control" id="telefoneFixo" value="<?php echo $contatosSetoriais->CSE_TELEFONE_FIXO ?>" required>
                            <div class="validate"></div>
                        </div>
                        <div class="mb-3">
                            Telefone celular
                            <input type="tel" name="CSE_TELEFONE_CELULAR" class="form-control" id="telefoneCelular" value="<?php echo $contatosSetoriais->CSE_TELEFONE_CELULAR ?>" required>
                            <div class="validate"></div>
                        </div>
