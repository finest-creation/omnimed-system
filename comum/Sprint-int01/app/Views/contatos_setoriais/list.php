...
$contatosSetoriais = $contatosSetoriaisModel->findAll();
?>
    ...
    <main id="main">
        <section id="counts" class="counts">
            <div class="container">
                ...
                <a href="/contatos_setoriais/novo" class="appointment-btn scrollto">Cadastrar</a>
                <br />
                <br />
                            ...
                            <div class="gv">
                                <table id="example" class="table table-striped table-bordered grid" style="width:100%;">
                                    ...
                                    <tbody style="text-align: center;">
                                        <?php foreach ($contatosSetoriais as $key => $contato) { ?>
                                            <tr>
                                                <td><?php echo $contato->CSE_SETOR; ?></td>
                                                <td><?php echo $contato->CSE_EMAIL; ?></td>
                                                <td><?php echo $contato->CSE_TELEFONE_FIXO; ?></td>
                                                <td><?php echo $contato->CSE_TELEFONE_CELULAR; ?></td>
                                                <td><a href="/contatos_setoriais/excluir/<?php echo $contato->CSE_ID; ?>" class="deletar"><span class='bi bi-trash'></span></a></td>
                                                <td><a href="/contatos_setoriais/editar/<?php echo $contato->CSE_ID; ?>"><span class='bi bi-pencil-square'></span></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "language": {
                    ...
                    "search": "Pesquisar:",
                    "searchPlaceholder": "Setor, E-mail, Telefone...",
                    "paginate": {
                        "first": "Primeiro",
                        "last": "Último",
                        "next": "Próximo",
